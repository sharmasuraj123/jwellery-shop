    ...
    <nav className="glass-nav" data-testid="navbar">
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="text-2xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }} data-testid="nav-logo">
            Janki Jewellery
          </Link>
          ...
          <div className="flex items-center gap-6">
            {user ? (
              ...
              <Button onClick={onLoginClick} variant="outline" data-testid="nav-login-btn">
